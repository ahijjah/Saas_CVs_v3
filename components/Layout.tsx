...
const T = {
  en: {
    dashboard: 'Dashboard', jobs: 'Jobs', campaigns: 'Campaigns', candidates: 'Candidates', settings: 'Settings', planUsage: 'Plan & Usage',
  ...
  ar: {
    dashboard: 'لوحة التحكم', jobs: 'الوظائف', campaigns: 'الحملات', candidates: 'المرشحون', settings: 'الإعدادات', planUsage: 'الخطة والاستخدام',
