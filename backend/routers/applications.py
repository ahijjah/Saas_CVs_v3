...
async def get_application_details(
    ...
    row = await db.execute(
        text("""
            SELECT
                ...
                a.gatekeeper_passed,
                a.semantic_similarity_score,
                a.semantic_threshold,
                a.matched_skills        AS app_matched_skills,
                a.missing_skills        AS app_missing_skills,
                a.matched_keywords,
                a.missing_keywords,
                a.gatekeeper_reason_json,
    ...
    return {
        ...
        "local_similarity_score": float(app["semantic_similarity_score"] or app["local_similarity_score"]) if (app["semantic_similarity_score"] is not None or app["local_similarity_score"] is not None) else None,
        "skill_match_ratio":      float(app["skill_match_ratio"]) if app["skill_match_ratio"] is not None else None,
        "matched_skills":  (app["app_matched_skills"] or app["matched_skills"] or []),
        "missing_skills":  (app["app_missing_skills"] or app["missing_skills"] or []),
        "matched_keywords":           app["matched_keywords"] or [],
        "missing_keywords":           app["missing_keywords"] or [],
        "gatekeeper_reason_json":     app["gatekeeper_reason_json"] or {},
        "semantic_threshold":         float(app["semantic_threshold"]) if app["semantic_threshold"] is not None else None,
